...
class Progress {
  ...
  /// 3色の稽古を一度通したか。
  ///
  /// **いまは誰も読まない。** 教えていた巡回の決まりが無くなって、3色の
  /// 稽古そのものを落としたため（README 第22段階）。保存の形は変えたくない
  /// ので、読み書きだけ残してある――古い記録がここで落ちると、通した印まで
  /// 一緒に消える。決まりを入れ直すときはここから復活させる。
  bool taughtPrism;
  ...
  /// 盤面が3色になる相の数。編成を3色にすると、雷の「3色を含む」のような
  /// 条件が満たせるようになる。
  ...
  /// **相が1種類だけの編成は組めない。**
  ///
  /// 色の決まりが無くなる前は「1色の盤面では鎖が1枚も編めない」という
  /// 物理的な理由だった（README 第22段階）。いまは1色でもつなげるが、
  /// **盤面が単色だと色を読む意味がなくなる**（雷の「3色を含む」も、霜の
  /// 「その色から始める」も死ぬ）ので、縛りはそのまま残してある。
